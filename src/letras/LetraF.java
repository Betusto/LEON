 ...
 */
public class LetraF extends javax.swing.JFrame {
    ...
    public LetraF() {
        ...
        if (valor == 0) {
            ...
            Opcion1Button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/f.png")));
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"f".equals(letrarandom1) && !letrarandom1.equals(letrarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"f".equals(letrarandom2) && !letrarandom2.equals(letrarandom1)) {
            ...
            Opcion2Button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/f.png")));
            Opcion2Button.setSize(180, 180);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion2Button.setLocation(370, 390);
            ...
            Opcion3Button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/f.png")));
            Opcion3Button.setSize(180, 180);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(630, 180);

        }
        playSound("f"); //1=letra a
//}
//}
//
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LetraF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
