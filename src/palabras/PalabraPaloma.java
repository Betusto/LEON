 ...
 */
public class PalabraPaloma extends javax.swing.JFrame {
    ...
    public PalabraPaloma() {
        ...
        ImagenLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/paloma_palabras.png")));
        if (valor == 0) {
            //for (int i = 0; i < randomcheck; i++){
            //Boton 1, contiene la letra a
            Opcion1Button.setText("Paloma");
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"Paloma".equals(palabrarandom1) && !palabrarandom1.equals(palabrarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"Paloma".equals(palabrarandom2) && !palabrarandom2.equals(palabrarandom1)) {
            ...
            Opcion3Button.setText("Paloma");
            Opcion3Button.setSize(240, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(600, 470);

        }
        playSound("paloma"); //1=letra a
//}
//}
//
...
//}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PalabraPaloma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PalabraPaloma().setVisible(true);
            }
        });
    }
