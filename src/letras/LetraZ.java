 ...
 */
public class LetraZ extends javax.swing.JFrame {
    ...
    public LetraZ() {
        ...
        if (valor == 0) {
            ...
            Opcion1Button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/z.png")));
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"z".equals(letrarandom1) && !letrarandom1.equals(letrarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"z".equals(letrarandom2) && !letrarandom2.equals(letrarandom1)) {
            ...
            Opcion2Button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/z.png")));
            Opcion2Button.setSize(180, 180);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion2Button.setLocation(370, 390);
            ...
            Opcion3Button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/z.png")));
            Opcion3Button.setSize(180, 180);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(630, 180);

        }
        playSound("z"); //1=letra a
//}
//}
//
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    private void Opcion2ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Opcion2ButtonActionPerformed
        if (valor == 1) {
            ...
            Aciertos.Calcular();
            System.out.println(Aciertos.getValue());
            //Atributos de los botones del JOptionPane        
        JButton button = new JButton();
        button.setContentAreaFilled(false);
        button.setBorderPainted(false);
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                Calif.setSize(909, 655);
                Calif.setLocationRelativeTo(null);
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LetraZ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
