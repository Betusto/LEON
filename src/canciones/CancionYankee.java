 ...
 */
public class CancionYankee extends javax.swing.JFrame {
	...
	private final int WINDOW_HEIGHT = 655;
        public Clip clip;
        int vez = 0;
        LetraYankee Letra = new LetraYankee();

    /**
     * Creates new form FabricaDePalabras
     */
    public CancionYankee() {
                initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Compositor original: Dr. Richard Shuckburgh ");
        jPanel2.add(jLabel6);
        jLabel6.setBounds(10, 10, 460, 30);

        jLabel7.setFont(new java.awt.Font("Gill Sans MT", 0, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(51, 51, 51));
        jLabel7.setText("Interprete:  Campo Infantil");
        jPanel2.add(jLabel7);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/pluma128.png"))); // NOI18N
        ...
        InstruccionLabel.setText("Un yankee viaja a la ciudad");
        jPanel1.add(InstruccionLabel);
        InstruccionLabel.setBounds(260, 100, 420, 50);
        if(vez==0){
            try{
                stopSound();
                urlArchivoMusica = new URL("file:"+"src/sonidos/Un_Yankee_viaja.wav");//url del archivo a reproducir
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancionYankee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CancionYankee().setVisible(true);
            }
        });
    }
