 ...
 */
public class CancionGranja extends javax.swing.JFrame {
	...
	private final int WINDOW_HEIGHT = 655;
        public Clip clip;
        int vez = 0;
        LetraGranja Letra = new LetraGranja();

    /**
     * Creates new form FabricaDePalabras
     */
    public CancionGranja() {
                initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/granja128.png"))); // NOI18N
        ...
        InstruccionLabel.setFont(new java.awt.Font("Trebuchet MS", 0, 36)); // NOI18N
        InstruccionLabel.setText("El viejo McDonald");
        jPanel1.add(InstruccionLabel);
        InstruccionLabel.setBounds(310, 100, 290, 50);
        if(vez==0){
            try{
                stopSound();
                urlArchivoMusica = new URL("file:"+"src/sonidos/El_viejo_mcdonald.wav");//url del archivo a reproducir
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancionGranja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CancionGranja().setVisible(true);
            }
        });
    }
