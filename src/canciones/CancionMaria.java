 ...
 */
public class CancionMaria extends javax.swing.JFrame {
	...
	private final int WINDOW_HEIGHT = 655;
        public Clip clip;
        int vez = 0;
        LetraMaria Letra = new LetraMaria();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Compositor original: Sarah Josepha Hale ");
        jPanel2.add(jLabel6);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/corderito128.png"))); // NOI18N
        ...
        InstruccionLabel.setText("María tiene un corderito");
        jPanel1.add(InstruccionLabel);
        InstruccionLabel.setBounds(290, 100, 370, 40);
        if(vez==0){
            try{
                stopSound();
                urlArchivoMusica = new URL("file:"+"src/sonidos/Maria_tiene_un_corderito.wav");//url del archivo a reproducir
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancionMaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CancionMaria().setVisible(true);
            }
        });
    }
