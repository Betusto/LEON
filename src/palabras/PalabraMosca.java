 ...
 */
public class PalabraMosca extends javax.swing.JFrame {
    ...
    public PalabraMosca() {
        ...
        ImagenLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/mosca_palabras.png")));
        if (valor == 0) {
            //for (int i = 0; i < randomcheck; i++){
            //Boton 1, contiene la letra a
            Opcion1Button.setText("Mosca");
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"Mosca".equals(palabrarandom1) && !palabrarandom1.equals(palabrarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"Mosca".equals(palabrarandom2) && !palabrarandom2.equals(palabrarandom1)) {
            ...
            Opcion3Button.setText("Mosca");
            Opcion3Button.setSize(240, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(600, 470);

        }
        playSound("mosca"); //1=letra a
//}
//}
//
...
//}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PalabraMosca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PalabraMosca().setVisible(true);
            }
        });
    }
