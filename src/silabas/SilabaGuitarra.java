 ...
 */
public class SilabaGuitarra extends javax.swing.JFrame {
    ...
    public SilabaGuitarra() {
        ...
        ImagenLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/guitarra_silabas.png")));
        ...
        if (valor == 0) {
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"ta".equals(silabarandom1) && !silabarandom1.equals(silabarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"ta".equals(silabarandom2) && !silabarandom2.equals(silabarandom1)) {
            ...
            Opcion3Button.setText("ta");
            Opcion3Button.setSize(180, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(590, 470);

        }
        playSound("gui-ta-rra"); //1=letra a
//}
//}
//
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaPeluche Peluche = new SilabaPeluche();
                Peluche.setSize(909, 655);
                Peluche.setLocationRelativeTo(null);
                Peluche.setVisible(true);
                JOptionPane.getRootFrame().dispose();
                dispose();
                }               
            }
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaCamisa Camisa = new SilabaCamisa();
                Camisa.setSize(909, 655);
                Camisa.setLocationRelativeTo(null);
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaPantalon Pantalon = new SilabaPantalon();
                Pantalon.setSize(909, 655);
                Pantalon.setLocationRelativeTo(null);
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SilabaGuitarra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SilabaGuitarra().setVisible(true);
            }
        });
    }
