 ...
 */
public class CancionGranjero extends javax.swing.JFrame {
	...
	private final int WINDOW_HEIGHT = 655;
        public Clip clip;
        int vez = 0;
        LetraGranjero Letra = new LetraGranjero();

    /**
     * Creates new form FabricaDePalabras
     */
    public CancionGranjero() {
                initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Interprete:  BabyTV");
        jPanel2.add(jLabel7);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/granjero128.png"))); // NOI18N
        ...
        InstruccionLabel.setText("El granjero en la cañada");
        jPanel1.add(InstruccionLabel);
        InstruccionLabel.setBounds(280, 100, 370, 40);
        if(vez==0){
            try{
                stopSound();
                urlArchivoMusica = new URL("file:"+"src/sonidos/El_granjero_en_la_cañada.wav");//url del archivo a reproducir
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancionGranjero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CancionGranjero().setVisible(true);
            }
        });
    }
