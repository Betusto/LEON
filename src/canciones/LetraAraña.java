 ...
 */
public class LetraAraña extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TextArea.setRows(5);
        TextArea.setText("Incy Wincy araña, \ntejió su telaraña. \nVino la lluvia, \ny se la llevó. \n\nSalió el sol, \nse secó la lluvia. \nY Incy Wincy araña, \notra vez subió");
        jPanel1.add(TextArea);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LetraAraña.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LetraAraña().setVisible(true);
            }
        });
    }
