 ...
 */
public class SilabaVentana extends javax.swing.JFrame {
    ...
    public SilabaVentana() {
        ...
        ImagenLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ventana_silabas.png")));
        //Silaba1Panel.setVisible(false);
        Silaba4Panel.setVisible(false);
        //Guion1Label.setVisible(false);
        Guion3Label.setVisible(false);
        //Silaba3Panel.setVisible(false);
        //Guion2Label.setVisible(false);
        if (valor == 0) {
            //for (int i = 0; i < randomcheck; i++){
            //Boton 1, contiene la letra a
            Opcion1Button.setText("na");
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"na".equals(silabarandom1) && !silabarandom1.equals(silabarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"na".equals(silabarandom2) && !silabarandom2.equals(silabarandom1)) {
            ...
            Opcion3Button.setText("na");
            Opcion3Button.setSize(180, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(590, 470);

        }
        playSound("ven-ta-na"); //1=letra a
//}
//}
//
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaEdificio Edificio = new SilabaEdificio();
                Edificio.setSize(909, 655);
                Edificio.setLocationRelativeTo(null);
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaMoto Moto = new SilabaMoto();
                Moto.setSize(909, 655);
                Moto.setLocationRelativeTo(null);
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaSilla Silla = new SilabaSilla();
                Silla.setSize(909, 655);
                Silla.setLocationRelativeTo(null);
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SilabaVentana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SilabaVentana().setVisible(true);
            }
        });
    }
