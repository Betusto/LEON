 ...
 */
public class SilabaDurazno extends javax.swing.JFrame {
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaCalamar Calamar = new SilabaCalamar();
                Calamar.setSize(909, 655);
                Calamar.setLocationRelativeTo(null);
                Calamar.setVisible(true);
                JOptionPane.getRootFrame().dispose();
                dispose();
                }               
            }
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SilabaDurazno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SilabaDurazno().setVisible(true);
            }
        });
    }
