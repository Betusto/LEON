 ...
 */
public class PalabraDoctor extends javax.swing.JFrame {
    ...
    public PalabraDoctor() {
        ...
        ImagenLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/doctor_palabras.png")));
        if (valor == 0) {
            //for (int i = 0; i < randomcheck; i++){
            //Boton 1, contiene la letra a
            Opcion1Button.setText("Doctor");
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"Doctor".equals(palabrarandom1) && !palabrarandom1.equals(palabrarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"Doctor".equals(palabrarandom2) && !palabrarandom2.equals(palabrarandom1)) {
            ...
            Opcion3Button.setText("Doctor");
            Opcion3Button.setSize(240, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(600, 470);

        }
        playSound("doctor"); //1=letra a
//}
//}
//
...
//}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PalabraDoctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PalabraDoctor().setVisible(true);
            }
        });
    }
