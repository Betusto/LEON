 ...
 */
public class SilabaCaballo extends javax.swing.JFrame {
    ...
    public SilabaCaballo() {
        ...
        ImagenLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/caballo_silabas.png")));
        ...
        if (valor == 0) {
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"ba".equals(silabarandom1) && !silabarandom1.equals(silabarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"ba".equals(silabarandom2) && !silabarandom2.equals(silabarandom1)) {
            ...
            Opcion3Button.setText("ba");
            Opcion3Button.setSize(180, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(590, 470);

        }
        playSound("ca-ba-llo"); //1=letra a
//}
//}
//
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaGrillo Grillo = new SilabaGrillo();
                Grillo.setSize(909, 655);
                Grillo.setLocationRelativeTo(null);
                Grillo.setVisible(true);
                JOptionPane.getRootFrame().dispose();
                dispose();
                }               
            }
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaDinero Dinero = new SilabaDinero();
                Dinero.setSize(909, 655);
                Dinero.setLocationRelativeTo(null);
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaMariposa Mariposa = new SilabaMariposa();
                Mariposa.setSize(909, 655);
                Mariposa.setLocationRelativeTo(null);
                Mariposa.setVisible(true);
                JOptionPane.getRootFrame().dispose();
                dispose();
                }
            }
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SilabaCaballo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SilabaCaballo().setVisible(true);
            }
        });
    }
