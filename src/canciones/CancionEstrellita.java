 ...
 */
public class CancionEstrellita extends javax.swing.JFrame {
	...
	private final int WINDOW_HEIGHT = 655;
        public Clip clip;
        int vez = 0;
        LetraEstrellita Letra = new LetraEstrellita();

    /**
     * Creates new form FabricaDePalabras
     */
    public CancionEstrellita() {
                initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/estrellita128.png"))); // NOI18N
        ...
        InstruccionLabel.setText("Estrellita dónde estás");
        jPanel1.add(InstruccionLabel);
        InstruccionLabel.setBounds(300, 100, 320, 40);
        if(vez==0){
            try{
                stopSound();
                urlArchivoMusica = new URL("file:"+"src/sonidos/Estrellita_donde_estas.wav");//url del archivo a reproducir
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancionEstrellita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CancionEstrellita().setVisible(true);
            }
        });
    }
