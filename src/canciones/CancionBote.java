 ...
 */
public class CancionBote extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Compositor original: Eliphalet Oram Lyte");
        jPanel2.add(jLabel6);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/bote128.png"))); // NOI18N
        ...
        InstruccionLabel.setText("Rema tu bote");
        jPanel1.add(InstruccionLabel);
        InstruccionLabel.setBounds(360, 100, 220, 50);
        if(vez==0){
            try{
                stopSound();
                urlArchivoMusica = new URL("file:"+"src/sonidos/Rema_tu_bote.wav");//url del archivo a reproducir
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancionBote.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CancionBote().setVisible(true);
            }
        });
    }
