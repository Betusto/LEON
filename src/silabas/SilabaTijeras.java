 ...
 */
public class SilabaTijeras extends javax.swing.JFrame {
    ...
    public SilabaTijeras() {
        ...
        ImagenLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/tijeras_silabas.png")));
        ...
        if (valor == 0) {
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"ras".equals(silabarandom1) && !silabarandom1.equals(silabarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"ras".equals(silabarandom2) && !silabarandom2.equals(silabarandom1)) {
            ...
            Opcion3Button.setText("ras");
            Opcion3Button.setSize(180, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(590, 470);

        }
        playSound("ti-je-ras"); //1=letra a
//}
//}
//
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaLeon Leon = new SilabaLeon();
                Leon.setSize(909, 655);
                Leon.setLocationRelativeTo(null);
                Leon.setVisible(true);
                JOptionPane.getRootFrame().dispose();
                dispose();
                }               
            }
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaBicicleta Bicicleta = new SilabaBicicleta();
                Bicicleta.setSize(909, 655);
                Bicicleta.setLocationRelativeTo(null);
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaLapiz Lapiz = new SilabaLapiz();
                Lapiz.setSize(909, 655);
                Lapiz.setLocationRelativeTo(null);
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SilabaTijeras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SilabaTijeras().setVisible(true);
            }
        });
    }
