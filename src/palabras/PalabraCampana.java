 ...
 */
public class PalabraCampana extends javax.swing.JFrame {
    ...
    public PalabraCampana() {
        ...
        String palabras = "Campana Camarón Aguacate Payaso Platano Mago Pino Arbusto Árbol Maceta Cohete Nube Nuez Lagartija Cocodrilo Mosca Abeja Colibrí Libreta Pluma Laptop Audifonos Vestido Televisión Cine Palomitas Abuela Paloma Familia Calavera Calabaza Bruja Duende Nariz Ojos Manos Lombriz Tortuga Gusano Conejo Reloj Pantunflas Pie Mecedora Pepino Zanahoria Kiosko Elote Patineta Gorra Policía Doctor Martillo Puerta Afilador Bombero Destornilla Maestra Espacial Chef";
        String[] palabrasep = palabras.split("\\s+");
        int randomcheck = 1;
        Random rand1 = new Random();
        valor = rand1.nextInt(3);
        String palabrarandom1 = palabrasep[new Random().nextInt(palabrasep.length)];
        String palabrarandom2 = palabrasep[new Random().nextInt(palabrasep.length)];
        //Elementos visibles e invisibles de la palabra
        ImagenLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/campana_palabras.png")));
        if (valor == 0) {
            //for (int i = 0; i < randomcheck; i++){
            //Boton 1, contiene la letra a
            Opcion1Button.setText("Campana");
            Opcion1Button.setSize(240, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion1Button.setLocation(60, 470);
            //}
            //Boton 2, letra random
            for (int i = 0; i < randomcheck; i++) {
                if (!"Campana".equals(palabrarandom1) && !palabrarandom1.equals(palabrarandom2)) {
                    Opcion2Button.setText(palabrarandom1);
                    Opcion2Button.setSize(240, 80);
                    //jButton1.setLocation(350, 200); //para el segundo boton
                    Opcion2Button.setLocation(330, 470);
                    randomcheck = 1;
                } else {
                    palabrarandom1 = palabrasep[new Random().nextInt(palabrasep.length)];
                    randomcheck++;
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"Campana".equals(palabrarandom2) && !palabrarandom2.equals(palabrarandom1)) {
                    Opcion3Button.setText(palabrarandom2);
                    Opcion3Button.setSize(240, 80);
                    //jButton1.setLocation(350, 200); //para el segundo boton
                    Opcion3Button.setLocation(600, 470);
                    randomcheck = 1;
                } else {
                    palabrarandom2 = palabrasep[new Random().nextInt(palabrasep.length)];
                    randomcheck++;
                    System.out.println("Se incremento el randomcheck");
                }
            }
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"Campana".equals(palabrarandom1) && !palabrarandom1.equals(palabrarandom2)) {
                    Opcion1Button.setText(palabrarandom1);
                    Opcion1Button.setSize(240, 80);
                    //jButton1.setLocation(350, 200); //para el segundo boton
                    Opcion1Button.setLocation(60, 470);
                    randomcheck = 1;
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"Campana".equals(palabrarandom2) && !palabrarandom2.equals(palabrarandom1)) {
                    Opcion2Button.setText(palabrarandom2);
                    Opcion2Button.setSize(240, 80);
                    //jButton1.setLocation(350, 200); //para el segundo boton
                    Opcion2Button.setLocation(330, 470);
                    randomcheck = 1;
            ...
            Opcion3Button.setText("Campana");
            Opcion3Button.setSize(240, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(600, 470);

        }
        playSound("campana"); //1=letra a
//}
//}
//
...
//}
    ...
    private void initComponents() {
        ...
        Opcion1Button.setBounds(60, 470, 240, 80);
        ...
        Opcion2Button.setBounds(330, 470, 240, 80);
        ...
        Opcion3Button.setBounds(600, 470, 240, 80);

        InstruccionLabel.setFont(new java.awt.Font("Tw Cen MT", 0, 36)); // NOI18N
        InstruccionLabel.setText("Elige la palabra de la imagen");
        jPanel1.add(InstruccionLabel);
        InstruccionLabel.setBounds(250, 0, 460, 40);
        jPanel1.add(ImagenLabel);
        ImagenLabel.setBounds(302, 130, 310, 310);
            ...
            button.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent actionEvent) {
                    ...
                    if(Aciertos.getPreguntas() == 30){
                        CalificacionPalabras CalPal = new CalificacionPalabras();
                        CalPal.setSize(909, 655);
                        CalPal.setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PalabraCampana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PalabraCampana().setVisible(true);
            }
        });
    }
