 ...
 */
public class CancionABC extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/abc128.png"))); // NOI18N
        ...
        InstruccionLabel.setText("La canción del ABC");
        jPanel1.add(InstruccionLabel);
        InstruccionLabel.setBounds(320, 100, 310, 40);
        if(vez==0){
            try{
                stopSound();
                urlArchivoMusica = new URL("file:"+"src/sonidos/La_cancion_del_abc.wav");//url del archivo a reproducir
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancionABC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CancionABC().setVisible(true);
            }
        });
    }
