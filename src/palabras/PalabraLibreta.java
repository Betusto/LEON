 ...
 */
public class PalabraLibreta extends javax.swing.JFrame {
    ...
    public PalabraLibreta() {
        ...
        ImagenLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/libreta_palabras.png")));
        if (valor == 0) {
            //for (int i = 0; i < randomcheck; i++){
            //Boton 1, contiene la letra a
            Opcion1Button.setText("Libreta");
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"Libreta".equals(palabrarandom1) && !palabrarandom1.equals(palabrarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"Libreta".equals(palabrarandom2) && !palabrarandom2.equals(palabrarandom1)) {
            ...
            Opcion3Button.setText("Libreta");
            Opcion3Button.setSize(240, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(600, 470);

        }
        playSound("libreta"); //1=letra a
//}
//}
//
...
//}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PalabraLibreta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PalabraLibreta().setVisible(true);
            }
        });
    }
