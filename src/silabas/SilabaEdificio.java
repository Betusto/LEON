 ...
 */
public class SilabaEdificio extends javax.swing.JFrame {
    ...
    public SilabaEdificio() {
        ...
        ImagenLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/edificio_silabas.png")));
       ...
       // Guion3Label.setVisible(false);
        if (valor == 0) {
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"fi".equals(silabarandom1) && !silabarandom1.equals(silabarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"fi".equals(silabarandom2) && !silabarandom2.equals(silabarandom1)) {
            ...
            Opcion3Button.setText("fi");
            Opcion3Button.setSize(180, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(590, 470);

        }
        playSound("e-di-fi-cio"); //1=letra a
//}
//}
//
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaYoyo Yoyo = new SilabaYoyo();
                Yoyo.setSize(909, 655);
                Yoyo.setLocationRelativeTo(null);
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaVaca Vaca = new SilabaVaca();
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaNaranja Naranja = new SilabaNaranja();
                Naranja.setSize(909, 655);
                Naranja.setLocationRelativeTo(null);
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SilabaEdificio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SilabaEdificio().setVisible(true);
            }
        });
    }
