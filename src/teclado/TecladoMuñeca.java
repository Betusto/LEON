 ...
 */
public class TecladoMuñeca extends javax.swing.JFrame {
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    private void NextButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextButtonActionPerformed
        ...
        RespuestaTextField.setText("Muñeca");
    ...
    private void CheckButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckButtonActionPerformed
           ...
           if("Muñeca".equals(respuesta_mayuscula)){
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    private void PistaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PistaButtonActionPerformed
        ...
        RespuestaTextField.setText("Muñe");
        }
        pista = 1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TecladoMuñeca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TecladoMuñeca().setVisible(true);
            }
        });
    }
