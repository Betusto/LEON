 ...
 */
public class SilabaBicicleta extends javax.swing.JFrame {
    ...
    public SilabaBicicleta() {
        ...
        ImagenLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/bicicleta_silabas.png")));
        ...
        if (valor == 0) {
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"cle".equals(silabarandom1) && !silabarandom1.equals(silabarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"cle".equals(silabarandom2) && !silabarandom2.equals(silabarandom1)) {
            ...
            Opcion3Button.setText("cle");
            Opcion3Button.setSize(180, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(590, 470);

        }
        playSound("bi-ci-cle-ta"); //1=letra a
//}
//}
//
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaAuto Auto = new SilabaAuto();
                Auto.setSize(909, 655);
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaFlamingo Flamingo = new SilabaFlamingo();
                Flamingo.setSize(909, 655);
                Flamingo.setLocationRelativeTo(null);
                Flamingo.setVisible(true);
                JOptionPane.getRootFrame().dispose();
                dispose();
                }
            }
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SilabaBicicleta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SilabaBicicleta().setVisible(true);
            }
        });
    }
