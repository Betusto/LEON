 ...
 */
public class SilabaCuchara extends javax.swing.JFrame {
    ...
    public SilabaCuchara() {
        ...
        ImagenLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/cuchara_silabas.png")));
        ...
        if (valor == 0) {
            ...
            for (int i = 0; i < randomcheck; i++) {
                if (!"ra".equals(silabarandom1) && !silabarandom1.equals(silabarandom2)) {
            ...
            //do{
            for (int i = 0; i < randomcheck; i++) {
                if (!"ra".equals(silabarandom2) && !silabarandom2.equals(silabarandom1)) {
            ...
            Opcion3Button.setText("ra");
            Opcion3Button.setSize(180, 80);
            //jButton1.setLocation(350, 200); //para el segundo boton
            Opcion3Button.setLocation(590, 470);

        }
        playSound("cu-cha-ra"); //1=letra a
//}
//}
//
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaManzana Manzana = new SilabaManzana();
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaPiña Piña = new SilabaPiña();
                Piña.setSize(909, 655);
                Piña.setLocationRelativeTo(null);
                Piña.setVisible(true);
                JOptionPane.getRootFrame().dispose();
                dispose();
                }
            }
...
//Metodo para cuando se oprima el boton de confirmacion de salir
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                SilabaMontaña Montaña = new SilabaMontaña();
                Montaña.setSize(909, 655);
                Montaña.setLocationRelativeTo(null);
                Montaña.setVisible(true);
                JOptionPane.getRootFrame().dispose();
                dispose();
                }
            }
...
//Declaramos los botones que se van a usar en el cuadro de dialogo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SilabaCuchara.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SilabaCuchara().setVisible(true);
            }
        });
    }
