 ...
 */
public class LetraMaria extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TextArea.setRows(5);
        TextArea.setText("María tiene un corderito \nCorderito, corderito \nMaría tiene un corderito \nblanco y juguetón. \n\nAlla donde María va\nMaría va, María va, \nAlla donde María va\nEl corderito va detrás. ");
        jPanel1.add(TextArea);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LetraMaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LetraMaria().setVisible(true);
            }
        });
    }
